(function(){
	...
	*/
	...
	/*
	Sem alterar os códigos nos `console. og` abaixo, faça com que o retorno
	...
	*/
	function showErrorMessage( operator ){
		return 'operador "'+operator+'" não permitida!';
	}
	/*
	...
	*/
	...
	if( subtraction ) {
		number1 = 8;
		number = 11;
		console.log( showOperationMessage( operationSignal, number1, number ), subtraction( number1, number2));
	}
	else { 
		console.log( showErrorMessage(operationSignal));
	}
	...
	if( multiplication ) {
		number1 = 3;
		number = 9;
		console.log( showOperationMessage( operationSignal, number1, number ), multiplication( number1, number2));
	}
	else { 
		console.log( showErrorMessage(operationSignal));
	}
	...
	if( division ) {
		number1 = 4;
		number = 2;
		console.log( showOperationMessage( operationSignal, number1, number ), division( number1, number2));
	}
	else { 
		console.log( showErrorMessage(operationSignal));
	}
	...
	if( mod ) {
		number1 = 7;
		number = 2;
		console.log( showOperationMessage( operationSignal, number1, number ), mod( number1, number2));
	}
	else { 
		console.log( showErrorMessage(operationSignal));
	}
	...
	*/
	...
	if( invalid ) {
		number1 = 8;
		number = 11;
		console.log( showOperationMessage( operationSignal, number1, number ), invalid( number1, number2));
	}
	else { 
		console.log( showErrorMessage(operationSignal));
	}
