(function(){ 
  ...
  */
  ...
  var Lucas = new Person('José', 'Lucas', 23 );
  var Gabriel = new Person('Gabriel', 'Levi', 0.7);
  var Julia = new Person('Julia', 'torres', 0.0);
  console.log(Lucas);
  console.log(Gabriel);
  console.log(Julia);
  /*
  ...
  */
  ...
  console.log(Gabriel.getFullName() + ' agora tem ' + Gabriel.addAge(1).getAge() + ' anos. ');
  console.log(Julia.getFullName() + ' agora tem ' + Julia.addAge(1).getAge() + ' anos. ');
  })();
