...
*/
var sul = ['Paraná', 'Santa Catrina', 'Rio do Sul'];
var sudeste = ['Minas Gerais', 'São Paulo', 'Rio de Janeiro', 'Vitoria'];
...
brasil.unshift('Amazonia', 'rondonia', 'acre');
console.log(brasil);
/*
...
*/
var nordeste = ['maranhão', 'bahia', 'Ceará'];
